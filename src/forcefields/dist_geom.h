...
using Energy3DForceContribsDeviceF32 = Energy3DForceContribsDeviceT<float>;
...
using BatchedMolecularDeviceBuffersF32Params   = BatchedMolecularDeviceBuffersT<float>;
using BatchedMolecular3DDeviceBuffers          = BatchedMolecular3DDeviceBuffersT<double>;
using BatchedMolecular3DDeviceBuffersF32Params = BatchedMolecular3DDeviceBuffersT<float>;
...
void setStreams(BatchedMolecularDeviceBuffersF32Params& devBuffers, cudaStream_t stream);
...
void setStreams(BatchedMolecular3DDeviceBuffersF32Params& devBuffers, cudaStream_t stream);
...
void sendContribsAndIndicesToDevice3D(const BatchedMolecularSystem3DHost&       molSystemHost,
                                      BatchedMolecular3DDeviceBuffersF32Params& molSystemDevice);
