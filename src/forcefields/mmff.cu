...
void sendContribsAndIndicesToDevice(const BatchedMolecularSystemHost& molSystemHost,
  ...
  deviceContribs.distanceConstraintTerms.forceConstant.setFromVector(hostContribs.distanceConstraintTerms.forceConstant);
  ...
  deviceContribs.positionConstraintTerms.forceConstant.setFromVector(hostContribs.positionConstraintTerms.forceConstant);
  ...
  deviceContribs.torsionConstraintTerms.minDihedralDeg.setFromVector(hostContribs.torsionConstraintTerms.minDihedralDeg);
  deviceContribs.torsionConstraintTerms.maxDihedralDeg.setFromVector(hostContribs.torsionConstraintTerms.maxDihedralDeg);
...
void addMoleculeToBatch(const EnergyForceContribsHost& contribs,
  ...
  for (size_t i = 0; i < contribs.distanceConstraintTerms.idx1.size(); i++) {
    contribHolder.distanceConstraintTerms.idx1.push_back(contribs.distanceConstraintTerms.idx1[i] + previousLastAtomIndex);
    contribHolder.distanceConstraintTerms.idx2.push_back(contribs.distanceConstraintTerms.idx2[i] + previousLastAtomIndex);
  ...
  for (size_t i = 0; i < contribs.positionConstraintTerms.idx.size(); i++) {
    contribHolder.positionConstraintTerms.idx.push_back(contribs.positionConstraintTerms.idx[i] + previousLastAtomIndex);
  ...
  for (size_t i = 0; i < contribs.torsionConstraintTerms.idx1.size(); i++) {
    contribHolder.torsionConstraintTerms.idx1.push_back(contribs.torsionConstraintTerms.idx1[i] + previousLastAtomIndex);
    contribHolder.torsionConstraintTerms.idx2.push_back(contribs.torsionConstraintTerms.idx2[i] + previousLastAtomIndex);
    contribHolder.torsionConstraintTerms.idx3.push_back(contribs.torsionConstraintTerms.idx3[i] + previousLastAtomIndex);
    contribHolder.torsionConstraintTerms.idx4.push_back(contribs.torsionConstraintTerms.idx4[i] + previousLastAtomIndex);
...
cudaError_t computeGradients(BatchedMolecularDeviceBuffers& molSystemDevice, cudaStream_t stream) {
  return computeGradients(molSystemDevice, molSystemDevice.positions.data(), molSystemDevice.grad.data(), nullptr, stream);
}
