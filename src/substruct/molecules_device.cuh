...
struct MoleculeViewT;

/**
 * @brief Per-molecule view for target molecules.
 */
template <>
struct MoleculeViewT<MoleculeType::Target> {
  int numAtoms;
 ...
 */
template <>
struct MoleculeViewT<MoleculeType::Query> {
  int numAtoms;
  ...
  __device__ __forceinline__ QueryAtomBonds const& getQueryBonds(int atomIdx) const {
