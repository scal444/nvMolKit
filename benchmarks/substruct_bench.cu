...
int main(int argc, char* argv[]) {
  ...
  benchNvMolKit(targetMols, queryMols, algorithm, batchSize, numThreads, nvmolkitMatches, nvmolkitResults, nvmolkitTiming, benchIterations);
  ...
  if (doRdkit) {
    benchRDKit(targetMols, queryMols, rdkitMatches, rdkitTiming, benchIterations);
